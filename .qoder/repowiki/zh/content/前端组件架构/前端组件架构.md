...
- ProductCopyPage：产品文案生成，支持独立英译与 TTS（MP3+SRT）。
...
- [web/src/pages/ProductCopyPage.tsx:13-89](file://web/src/pages/ProductCopyPage.tsx#L13-L89)
...
## 结论
该前端组件架构以 Ant Design 为基础，结合 React Router 与自研 API 层，实现了清晰的路由与权限控制、可复用的布局组件、统一的结果面板与流式处理能力。通过模块化的页面组件与通用组件，提升了开发效率与一致性。后续可在流式渲染优化、可访问性增强与主题扩展方面持续演进。
...
- [web/src/pages/ProductCopyPage.tsx:164-246](file://web/src/pages/ProductCopyPage.tsx#L164-L246)
