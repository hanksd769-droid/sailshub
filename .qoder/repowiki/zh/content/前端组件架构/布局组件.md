...
## 更新摘要
**所做更改**
- 更新主布局组件中的版本显示文本，从 v1.8.0 升级到 v2.1.0
- 维护现有架构和功能描述的完整性
- 保持文档结构和引用格式的一致性
...
- [MainLayout.tsx:1-69](file://web/src/layouts/MainLayout.tsx#L1-L69)
...
**章节来源**
- [MainLayout.tsx:19-69](file://web/src/layouts/MainLayout.tsx#L19-L69)
...
**图表来源**
- [App.tsx:19-23](file://web/src/App.tsx#L19-L23)
- [App.tsx:50-55](file://web/src/App.tsx#L50-L55)

**章节来源**
- [App.tsx:19-55](file://web/src/App.tsx#L19-L55)
...
**图表来源**
- [MainLayout.tsx:17-69](file://web/src/layouts/MainLayout.tsx#L17-L69)
...
**章节来源**
- [MainLayout.tsx:28-38](file://web/src/layouts/MainLayout.tsx#L28-L38)
...
**章节来源**
- [MainLayout.tsx:52-59](file://web/src/layouts/MainLayout.tsx#L52-L59)
...
**章节来源**
- [MainLayout.tsx:61-63](file://web/src/layouts/MainLayout.tsx#L61-L63)
...
**图表来源**
- [App.tsx:19-23](file://web/src/App.tsx#L19-L23)
- [App.tsx:28-41](file://web/src/App.tsx#L28-L41)

**章节来源**
- [App.tsx:19-41](file://web/src/App.tsx#L19-L41)
...
**图表来源**
- [App.tsx:1-17](file://web/src/App.tsx#L1-L17)
- [MainLayout.tsx:1-15](file://web/src/layouts/MainLayout.tsx#L1-L15)
...
**更新** 版本号从 v1.8.0 更新为 v2.1.0，反映了应用的最新版本信息，但不影响功能实现和架构设计。