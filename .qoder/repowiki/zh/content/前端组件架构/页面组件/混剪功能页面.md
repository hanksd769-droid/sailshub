...
**图表来源**
- [MixCutPage.tsx:1-316](file://web/src/pages/MixCutPage.tsx#L1-L316)
- [CopyLibraryPage.tsx:1-181](file://web/src/pages/CopyLibraryPage.tsx#L1-L181)
- [api.ts:1-208](file://web/src/lib/api.ts#L1-L208)
...
- **流式处理**：通过 Server-Sent Events 实现实时进度反馈和结果更新
...
音频URL提取的具体实现：
- **逐条音频提取**：遍历 `tts_individual` 数组，从每个元素的 `tts.data[0].url` 提取URL
- **合并音频提取**：从 `tts_merged.data[0].url` 提取合并音频URL
