...
**更新** 最新版本重点改进了TTS数据结构处理逻辑，增强了对tts_merged属性的安全访问模式，添加了更清晰的数据结构注释，明确了tts_merged的结构说明，提升了代码的可读性和安全性。
...
**图表来源**
- [MixCutPage.tsx:1-318](file://web/src/pages/MixCutPage.tsx#L1-L318)
- [CopyLibraryPage.tsx:1-181](file://web/src/pages/CopyLibraryPage.tsx#L1-L181)
- [api.ts:1-239](file://web/src/lib/api.ts#L1-L239)
