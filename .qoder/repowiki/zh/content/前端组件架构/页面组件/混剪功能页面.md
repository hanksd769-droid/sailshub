...
**更新** 新版本引入了更友好的初始值设置、实时进度跟踪和可视化的进度条，以及改进的结果展示功能，支持单独音频片段和合并音频输出的分离展示。
...
**图表来源**
- [MixCutPage.tsx:1-222](file://web/src/pages/MixCutPage.tsx#L1-L222)
...
- [MixCutPage.tsx:169-215](file://web/src/pages/MixCutPage.tsx#L169-L215)

**章节来源**
- [MixCutPage.tsx:140-215](file://web/src/pages/MixCutPage.tsx#L140-L215)
