...
复制库系统的核心数据模型围绕`copy_library`表设计，支持多种类型的内容存储：
...
**章节来源**
- [api/src/routes/copyLibrary.ts:7-169](file://api/src/routes/copyLibrary.ts#L7-L169)
...
**图表来源**
- [api/src/routes/copyLibrary.ts:8-167](file://api/src/routes/copyLibrary.ts#L8-L167)
...
**更新总结** 本次更新反映了系统的最新改进：认证中间件名称标准化、用户ID提取规范化、API响应消息国际化以及路由处理器函数名标准化，这些变更提升了系统的可维护性和国际化支持能力。