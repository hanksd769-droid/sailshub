...
## 更新摘要
**变更内容**
- 新增 `/api/voice/translate-lines` 端点，支持独立的批量翻译功能
- 新增 `/api/voice/tts-from-lines` 端点，支持直接从英文行数组生成语音
- 更新前端API封装，添加新的翻译和TTS调用函数
- 增强调试系统，支持更详细的中间状态追踪
...
- [web/src/lib/api.ts:119-162](file://web/src/lib/api.ts#L119-L162)
